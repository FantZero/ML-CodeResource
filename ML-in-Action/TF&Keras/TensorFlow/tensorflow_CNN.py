# -*- coding: utf-8 -*-
"""
Created on Tue Dec 11 18:52:23 2018
...
def weight_variable(shape):
    initial = tf.truncated_normal(shape, stddev=0.1)    #生成随机参数
...
# func1 layer
W_fc1 = weight_variable([7*7*64, 1024])     #7*7*64x1024
...
# the error between prediction and real data,成本函数是“交叉熵” -∑i yi * log(yi_pred)
